...
function dowell_init_menu() {
    add_menu_page( __( 'Dowell Opensource', 'dowell'), __( 'Dowell ', 'dowell'), 'manage_options', 'dowell', 'dowell_admin_page', 'dashicons-admin-plugins', '2.1' );
}
...
function compatibility(){ 
	...
	ob_start();
	?>
    <div id="dowell">Hello User. You are welcome</div>
